...
//Show Filter Options
$show_filter = Carbonick_Theme_Helper::get_option('portfolio_list_show_filter');
$list_terms =  Carbonick_Theme_Helper::get_option('portfolio_list_filter_cats');
...
$defaults = [
	...
	'nav_align' => 'center',
	'click_area' => 'single',
	'posts_per_row' => Carbonick_Theme_Helper::get_option('portfolio_list_columns'),
	'show_portfolio_title' => Carbonick_Theme_Helper::get_option('portfolio_list_show_title'),
	'show_content' => Carbonick_Theme_Helper::get_option('portfolio_list_show_content'),
	'show_meta_categories' => Carbonick_Theme_Helper::get_option('portfolio_list_show_cat'),
...
$sb = Carbonick_Theme_Helper::render_sidebars('portfolio_list');
			...
			if (! empty($term_id)) {
				echo '<div class="portfolio_archive-cat">',
					'<h4 class="portfolio_archive-cat_title">',
						esc_html__('Category:', 'carbonick-core'),
						' ',
						esc_html($cat_title),
					'</h4>',
