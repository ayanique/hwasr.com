...
class SidePanel
{
	...
	public function __construct()
	{
		...
		$this->name = __( 'Side Panel', 'carbonick-core' );
		$this->plural_name = __( 'Side Panels', 'carbonick-core' );
	...
	public function register()
	{
		$labels = [
			...
			'add_new'             => sprintf( __('Add New %s', 'carbonick-core' ), $this->name ),
			'add_new_item'        => sprintf( __('Add New %s', 'carbonick-core' ), $this->name ),
			'edit_item'           => sprintf( __('Edit %s', 'carbonick-core'), $this->name ),
			'new_item'            => sprintf( __('New %s', 'carbonick-core'), $this->name ),
	...
	public function wrapper_single_side_panel_open()
	{
		...
		$icon_background = Carbonick_Theme_Helper::get_option('bottom_header_side_panel_background');
		$icon_color = Carbonick_Theme_Helper::get_option('bottom_header_side_panel_color');
