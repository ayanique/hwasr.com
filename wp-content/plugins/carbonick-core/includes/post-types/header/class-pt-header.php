...
class Header
{
    ...
    {
        $this->name = __( 'Header Templates', 'carbonick-core' );
        $this->slug = 'header';
        $this->plural_name = __( 'Header Templates', 'carbonick-core' );
    ...
    public function register()
    {
        $labels = [
            ...
            'add_new' => sprintf( __('Add New Template', 'carbonick-core' ), $this->name ),
            ...
            'all_items' => sprintf( __('All Templates', 'carbonick-core'), $this->plural_name ),
