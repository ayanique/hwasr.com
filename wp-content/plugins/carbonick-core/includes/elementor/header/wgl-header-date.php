...
class Wgl_Header_Date extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('WGL Current Date', 'carbonick-core');
    }
    ...
    protected function _register_controls()
    {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Date Settings', 'carbonick-core'),
            ]
        );
        ...
        $this->add_control(
            'date_format_select',
            [
                'label' => esc_html__('Date Format', 'carbonick-core'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'default' => esc_html__('Default', 'carbonick-core'),
                    'wordpress_format' => esc_html__('Wordpress Format', 'carbonick-core'),
        ...
        $this->add_control(
            'date_format_custom',
            [
                'label' => esc_html__('Custom Date Format', 'carbonick-core'),
                ...
                'description' => __( 'Set your date format, about this, please refer to the ', 'carbonick-core') . sprintf( ' <a href="%1$s" target="_blank">%2$s</a>', 'https://wordpress.org/support/article/formatting-date-and-time/', __( 'Wordpress.org', 'carbonick-core') ),
            ]
        );         
        ...
        $this->add_control(
            'time_zone',
            [
                'label' => esc_html__('Time Zone', 'carbonick-core'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'UTC' => esc_html__('Default', 'carbonick-core'),
        ...
        $this->add_control(
            'date_color',
            [ 
                'label' => esc_html__('Text Idle', 'carbonick-core'),
    ...
    public function render(){
        ...
        echo '<div class="wgl-header-date'.esc_attr($class_date).'">';
            echo \Carbonick_Theme_Helper::render_html( $date->format( $date_format ) );
        echo '</div>';
    }
