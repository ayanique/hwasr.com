...
class Wgl_Header_Logo extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('WGL Logo', 'carbonick-core' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Logo Settings', 'carbonick-core' ),
            ]
        );
        ...
        $this->add_control(
            'use_custom_logo',
            array(
                'label' => esc_html__('Use Custom Logo?','carbonick-core' ),
        ...
        $this->add_control(
            'custom_logo',
            array(
                'label' => esc_html__( 'Custom Logo', 'carbonick-core' ),
        ...
        $this->add_control(
            'enable_logo_height',
            array(
                'label' => esc_html__('Enable Logo Height?','carbonick-core' ),
                'type' => Controls_Manager::SWITCHER,
                'condition' => [ 'use_custom_logo'  => 'yes' ],
            )
        );
        ...
        $this->add_control('logo_height',
            array(
                'label' => esc_html__('Logo Height', 'carbonick-core'),
    ...
    public function render() {
        ...
        new \Carbonick_Get_Logo( 'bottom', false, $logo, $custom_size );
    }
