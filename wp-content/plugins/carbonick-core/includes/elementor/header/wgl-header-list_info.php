...
class Wgl_Header_List_Info extends Widget_Base {
	...
	public function get_title() {
		return esc_html__('WGL Icon + Text', 'carbonick-core');
	}
	...
	protected function _register_controls()
	{
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('List Settings', 'carbonick-core'),
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'label_block' => true,
				'dynamic' => [ 'active' => true ],
				'placeholder' => esc_html__('List Item', 'carbonick-core'),
				'default' => esc_html__('List Item', 'carbonick-core'),
			]
		); 
		...
		$this->add_control(
			...
			[
				...
				'default' => [
					[ 'text' => esc_html__('List Item #1', 'carbonick-core') ],
					[ 'text' => esc_html__('List Item #2', 'carbonick-core') ],
					[ 'text' => esc_html__('List Item #3', 'carbonick-core') ],
				],
				'title_field' => '{{{ text }}}',
			]
		);
		...
		$this->start_controls_section(
			'section_icon_list',
			[
				'label' => esc_html__('List', 'carbonick-core'),
		...
		$this->add_responsive_control(
			'space_between',
			[
				'label' => esc_html__('Gap Items', 'carbonick-core'),
		...
		$this->add_control(
			'divider',
			[
				'label' => esc_html__('Divider', 'carbonick-core'),
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'solid' => esc_html__('Solid', 'carbonick-core'),
					'double' => esc_html__('Double', 'carbonick-core'),
					'dotted' => esc_html__('Dotted', 'carbonick-core'),
					'dashed' => esc_html__('Dashed', 'carbonick-core'),
				],
				'default' => 'solid',
				'selectors' => [
		...
		$this->add_control(
			'divider_weight',
			[
				'label' => esc_html__('Weight', 'carbonick-core'),
				'type' => Controls_Manager::SLIDER,
				'condition' => [ 'divider' => 'yes' ],
				'range' => [
					'px' => [ 'min' => 1, 'max' => 20 ],
		...
		$this->add_responsive_control(
			'icon_spacing',
			[
				'label' => esc_html__('Gap Icons', 'carbonick-core'),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [ 'min' => 0, 'max' => 100 ],
				],
