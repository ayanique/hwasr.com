...
class WglCountDown
{
    ...
    public function render( $self, $atts ){
        ...
        $data_array['labels'][]  =  esc_attr( esc_html__( '/ Years', 'carbonick-core' ) );
        $data_array['labels'][]  =  esc_attr( esc_html__( '/ Months', 'carbonick-core' ) );
        $data_array['labels'][]  =  esc_attr( esc_html__( '/ Weeks', 'carbonick-core' ) );
        $data_array['labels'][]  =  esc_attr( esc_html__( '/ Days', 'carbonick-core' ) );
        $data_array['labels'][]  =  esc_attr( esc_html__( '/ Hours', 'carbonick-core' ) );
        $data_array['labels'][]  =  esc_attr( esc_html__( '/ Minutes', 'carbonick-core' ) );
        $data_array['labels'][]  =  esc_attr( esc_html__( '/ Seconds', 'carbonick-core' ) );
        $data_array['labels1'][] =  esc_attr( esc_html__( '/ Year', 'carbonick-core' ) );
        $data_array['labels1'][] =  esc_attr( esc_html__( '/ Month', 'carbonick-core' ) );
        $data_array['labels1'][] =  esc_attr( esc_html__( '/ Week', 'carbonick-core' ) );
        $data_array['labels1'][] =  esc_attr( esc_html__( '/ Day', 'carbonick-core' ) );
        $data_array['labels1'][] =  esc_attr( esc_html__( '/ Hour', 'carbonick-core' ) );
        $data_array['labels1'][] =  esc_attr( esc_html__( '/ Minute', 'carbonick-core' ) );
        $data_array['labels1'][] =  esc_attr( esc_html__( '/ Second', 'carbonick-core' ) );
