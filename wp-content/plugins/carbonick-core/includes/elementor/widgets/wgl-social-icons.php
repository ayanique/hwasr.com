...
class Wgl_Social_Icons extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('WGL Social Icons', 'carbonick-core' );
    }
    ...
    protected function _register_controls() {
        $theme_color = esc_attr(\Carbonick_Theme_Helper::get_option('theme-custom-color'));
		...
		$this->start_controls_section(
			'section_social_icon',
			[
				'label' => esc_html__( 'Social Icons', 'carbonick-core' ),
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'default' => 'default',
				'options' => [
					'default' => esc_html__( 'Inherit', 'carbonick-core' ),
        ...
        $this->add_control(
			...
			[
				...
				'default' => [
					[
						'social_icon_title' => esc_html__( 'Twitter', 'carbonick-core' ),
						'social_icon_fontawesome' => [
					...
					[
						'social_icon_title' => esc_html__( 'Facebook', 'carbonick-core' ),
						'social_icon_fontawesome' => [
					...
					[
						'social_icon_title' => esc_html__( 'Instagram', 'carbonick-core' ),
						'social_icon_fontawesome' => [
		...
		$this->add_control(
			...
			[
				...
				'default' => 'rounded',
				'options' => [
					'rounded' => esc_html__( 'Rounded', 'carbonick-core' ),
        ...
        $this->add_control(
            'icon_padding',
            [
                'label' => esc_html__( 'Container Size', 'carbonick-core' ),
                'type' => Controls_Manager::SLIDER,
                'selectors' => [
