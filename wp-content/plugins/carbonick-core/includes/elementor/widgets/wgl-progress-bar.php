...
class Wgl_Progress_Bar extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('WGL Progress Bar', 'carbonick-core');
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section('wgl_progress_bar_section',
            array(
                'label'         => esc_html__('Progress Bar Settings', 'carbonick-core'),
            )
        );
        ...
        $this->add_control('progress_title',
            array(
				...
				'default' => esc_html__('My Skill', 'carbonick-core'),
				'label_block' => true,
            )
        );
        ...
        $this->add_control('units',
            array(
                'label'             => esc_html__('Units', 'carbonick-core'),
                'type'              => Controls_Manager::TEXT,
				'dynamic' => [
					'active' => true,
				],
				'placeholder' => esc_html__('Enter your units', 'carbonick-core'),
				'description' => esc_html__('Enter measurement units (Example: %, px, points, etc.)', 'carbonick-core'),
        ...
        $this->add_control(
			'value_pos',
			[
				'label' => esc_html__('Value Position', 'carbonick-core'),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'fixed' => esc_html__('Fixed', 'carbonick-core'),
					'dynamic' => esc_html__('Dynamic', 'carbonick-core'),
				],
				'default' => 'fixed',
			]
        );
        ...
        $this->start_controls_section(
            'bar_style_section',
            array(
                'label'     => esc_html__('Progress Bar', 'carbonick-core'),
                'tab'       => Controls_Manager::TAB_STYLE,
            )
        );
		...
		$this->add_control(
			'bar_height',
			[
				'label' => esc_html__('Progress Bar Height', 'carbonick-core'),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 1,
        ...
        $this->add_control(
            'bar_bg_color',
            array(
                'label' => esc_html__('Background Bar Color', 'carbonick-core'),
                'type' => Controls_Manager::COLOR,
                'default' => '#e7e7e7',
                'selectors' => array(
        ...
        $this->add_control(
            'bar_color',
            array(
                'label' => esc_html__('Bar Color', 'carbonick-core'),
                'type' => Controls_Manager::COLOR,
