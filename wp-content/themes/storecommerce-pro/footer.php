        ...
        <div class="container-wrapper">
            <div class="site-info-wrap">
                ...
                <div class="<?php echo esc_attr($class); ?>">
                    ...
                    <?php endif; ?>
                    <?php $storecommerce_theme_credits = storecommerce_get_option('hide_footer_copyright_credits'); ?>
                    <?php if ($storecommerce_theme_credits != 1): ?>
                        <span class="sep"> | </span>
                        <?php
                ...
                if (!empty($storecommerce_secure_payment_badge)):
                    ...
                    $storecommerce_open_on_new_tab = storecommerce_get_option('secure_payment_badge_open_in_new_tab');
