...
<div id="page" class="site">
    ...
    <header id="masthead" class="site-header">
        ...
        <?php
        $header_style = storecommerce_get_option('header_layout');
        if ($header_style == 'header-style-3') {
            storecommerce_get_block('header-center');
        } elseif ($header_style == 'header-style-2') {
            storecommerce_get_block('header-express');
        } else {
            storecommerce_get_block('header');
        }
    ...
    if ($show_main_banner_section):
        ...
        <section class="banner-slider">
            <?php
            $slider_mode = storecommerce_get_option('select_main_banner_section_mode');
            if ($slider_mode == 'product-slider'):
                ?>
                <?php storecommerce_get_block('slider-product'); ?>
            <?php else: ?>
