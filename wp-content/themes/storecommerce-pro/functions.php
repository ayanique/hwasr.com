    ...
    function storecommerce_ocdi_files()
    {
        ...
        return apply_filters('aft_demo_import_files', array(
            array(
                ...
                'import_file_name' => esc_html__('StoreCommerce Pro Default', 'storecommerce'),
                ...
                'import_preview_image_url'     => trailingslashit( get_template_directory_uri() ) . 'demo-content/assets/StoreCommerce-demo-preview.jpg',
                'preview_url' => 'https://demo.afthemes.com/storecommerce-pro/',
            ),

            array('import_file_name' => esc_html__('Gadgets Pro', 'storecommerce'),
                ...
                'import_preview_image_url'     => trailingslashit( get_template_directory_uri() ) . 'demo-content/assets/StoreCommerce-demo-preview-gadgets.jpg',
                'preview_url' => 'https://demo.afthemes.com/storecommerce-pro/gadgets-pro/',
            ),
            array('import_file_name' => esc_html__('Automobile Pro', 'storecommerce'),
                'local_import_file' => trailingslashit(get_template_directory()) . 'demo-content/automobile/storecommerce.xml',
                'local_import_widget_file' => trailingslashit(get_template_directory()) . 'demo-content/automobile/storecommerce.wie',
                'local_import_customizer_file' => trailingslashit(get_template_directory()) . 'demo-content/automobile/storecommerce.dat',
                'import_preview_image_url'     => trailingslashit( get_template_directory_uri() ) . 'demo-content/assets/StoreCommerce-demo-preview-automobile.jpg',
                'preview_url' => 'https://demo.afthemes.com/storecommerce-pro/automobile-pro/',
            ),
...
if (!function_exists('storecommerce_fonts_url')):
    ...
    function storecommerce_fonts_url()
    {
        ...
        $storecommerce_primary_font = storecommerce_get_option('primary_font');
        $storecommerce_secondary_font = storecommerce_get_option('secondary_font');

        $storecommerce_fonts = array();
        $storecommerce_fonts[] = $storecommerce_primary_font;
        $storecommerce_fonts[] = $storecommerce_secondary_font;

        $i = 0;
        for ($i = 0; $i < count($storecommerce_fonts); $i++) {

            if ('off' !== sprintf(_x('on', '%s font: on or off', 'storecommerce'), $storecommerce_fonts[$i])) {
                $fonts[] = $storecommerce_fonts[$i];
            }
...
function storecommerce_scripts()
{
    ...
    wp_add_inline_style('storecommerce-style', storecommerce_custom_style());
