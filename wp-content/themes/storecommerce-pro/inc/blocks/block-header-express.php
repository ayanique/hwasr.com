...
$header_style_transparent = storecommerce_get_option('header_layout_transparent');
if($header_style_transparent){
    $transparency_class = '';
    $slider_page_1 = storecommerce_get_option('slider_page_1');
    if(!empty($slider_page_1)){
        $header_style .= ' aft-transparent-header';
    }
}

?>
<div id="site-primary-navigation" class="<?php echo esc_attr($header_style); ?>">
