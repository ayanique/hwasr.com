...
$slider_page_4 = storecommerce_get_option('slider_page_4');
if (!empty($slider_page_4)) {
    $page_ids[] = $slider_page_4;
    $caption_class[] = storecommerce_get_option('page_caption_position_4');
    $button_text[] = storecommerce_get_option('button_text_4');
    $button_link[] = storecommerce_get_option('button_link_4');
}
$slider_page_5 = storecommerce_get_option('slider_page_5');
if (!empty($slider_page_5)) {
    $page_ids[] = $slider_page_5;
    $caption_class[] = storecommerce_get_option('page_caption_position_5');
    $button_text[] = storecommerce_get_option('button_text_5');
    $button_link[] = storecommerce_get_option('button_link_5');
}
