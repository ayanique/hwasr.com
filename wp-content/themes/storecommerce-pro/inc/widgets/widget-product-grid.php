...
if (!class_exists('StoreCommerce_Product_Grid')) :
    ...
    class StoreCommerce_Product_Grid extends AFthemes_Widget_Base
    {
        ...
        public function widget($args, $instance)
        {
            ...
            $number_of_items = isset($instance['storecommerce-number-of-items']) ? $instance['storecommerce-number-of-items'] : '8';
        ...
        public function form($instance)
        {
            ...
            if (isset($categories) && !empty($categories)) {
                ...
                echo parent::storecommerce_generate_text_input('storecommerce-number-of-items', __('No. of Items', 'storecommerce'), '8', 'number');
            }
