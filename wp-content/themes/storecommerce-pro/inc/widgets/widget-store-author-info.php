    ...
    class StoreCommerce_Store_Author_Info extends AFthemes_Widget_Base
    {
        ...
        public function form($instance)
        {
            ...
            if (isset($categories) && !empty($categories)) {
                ...
                echo parent::storecommerce_generate_text_input('storecommerce-author-info-twitter', __('Twitter', 'storecommerce'), '');
                echo parent::storecommerce_generate_text_input('storecommerce-author-info-linkedin', __('LinkedIn', 'storecommerce'), '');
                echo parent::storecommerce_generate_text_input('storecommerce-author-info-vk', __('VK', 'storecommerce'), '');
