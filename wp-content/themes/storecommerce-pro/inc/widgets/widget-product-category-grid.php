...
if (!class_exists('StoreCommerce_Product_Category_Grid')) :
    ...
    class StoreCommerce_Product_Category_Grid extends AFthemes_Widget_Base
    {
        ...
        public function widget($args, $instance)
        {
            ...
            $title_note = isset($instance['storecommerce-product-category-title-note']) ? $instance['storecommerce-product-category-title-note'] : '';
                    ...
                    <div class="section-body clearfix">
                        <div class="col-3 float-l pad btm-margi product-ful-wid">
                            <div class="sale-single-wrap">
                                <?php storecommerce_product_category_loop($category_1, $product_count, $onsale_product_count); ?>
                            </div>
                        </div>
                        <div class="col-3 float-l pad btm-margi product-ful-wid">
                            <div class="sale-single-wrap">
                                <?php storecommerce_product_category_loop($category_2, $product_count, $onsale_product_count); ?>
                            </div>
                        </div>
                        <div class="col-3 float-l pad btm-margi product-ful-wid">
                            <div class="sale-single-wrap">
                                <?php storecommerce_product_category_loop($category_3, $product_count, $onsale_product_count); ?>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        public function form($instance)
        {
            ...
            if (isset($categories) && !empty($categories)) {
                ...
                echo parent::storecommerce_generate_text_input('storecommerce-product-category-title-note', __('Title Note', 'storecommerce'), '');
