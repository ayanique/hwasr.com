...
if (!class_exists('StoreCommerce_Store_Call_to_Action')) :
    ...
    class StoreCommerce_Store_Call_to_Action extends AFthemes_Widget_Base
    {
        ...
        public function widget($args, $instance)
        {
            ...
            $date = isset($instance['storecommerce-call-to-action-date']) ? $instance['storecommerce-call-to-action-date'] : '';
                            ...
                            <div class="offer-main">
                                ...
                                <?php if (!empty($date)): ?>
                                    ...
                                    ?>
                                        ...
                                        <?php if ($difference->y > 0): ?>
                                            <span class="offer-date-item years">
                                        <span class="number">
                                            <?php echo esc_html($difference->y); ?>
                                        </span>
                                        <span class="text">
                                            <?php echo _e('Years', 'storecommerce'); ?>
                                        </span>
                                    </span>
                                        <?php endif; ?>
                                        <?php if ($difference->m > 0): ?>

                                            <span class="offer-date-item months">

                                        <span class="number">
                                            <?php echo esc_html($difference->m); ?>
                                        </span>
                                        <span class="text">
                                            <?php echo _e('Months', 'storecommerce'); ?>
                                        </span>
                                    </span>
                                        <?php endif; ?>
                                        <span class="offer-date-item days">

                                        <span class="number">
                                            <?php echo esc_html($difference->d); ?>
                                        </span>
                                        <span class="text">
                                            <?php echo _e('Days', 'storecommerce'); ?>
                                        </span>

                                    </span>
                                    <span class="offer-date-item hours">

                                        <span class="number">
                                            <?php echo esc_html($difference->h); ?>
                                        </span>
                                        <span class="text">
                                            <?php echo _e('Hours', 'storecommerce'); ?>
                                        </span>
                                    </span>
                                    <span class="offer-date-item minutes">

                                        <span class="number">
                                            <?php echo esc_html($difference->i); ?>
                                        </span>
                                        <span class="text">
                                            <?php echo _e('Minutes', 'storecommerce'); ?>
                                        </span>
                                    </span>

                                </span>
                                <?php endif; ?>
                                <span class="offer-time btn-style1"><a
                                            href="<?php echo esc_url($button_url); ?>"><?php echo esc_html($button_text); ?></a></span>
                            </div>
        ...
        public function form($instance)
        {
            ...
            echo parent::storecommerce_generate_text_input('storecommerce-call-to-action-date', 'Date', '', 'text', 'Enter date in yyyy-mm-dd format', 'storecommerce-call-to-action-date');
