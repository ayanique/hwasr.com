...
function storecommerce_widgets_init()
{
    ...
    register_sidebar(array(
        'name' => esc_html__('Above Top Header Section', 'storecommerce'),
        'id' => 'above-top-header-section',
        'description' => esc_html__('Add widgets for Above Top Header Section.', 'storecommerce'),
        'before_widget' => '<div id="%1$s" class="widget storecommerce-widget %2$s">',
        'after_widget' => '</div>',
        'before_title' => '<h2 class="widget-title widget-title-1"><span>',
        'after_title' => '</span></h2>',
    ...
    register_sidebar(array(
        ...
        'description' => esc_html__('Add widgets to front-page contents section.', 'storecommerce'),
        'before_widget' => '<div id="%1$s" class="widget storecommerce-widget %2$s">',
        'after_widget' => '</div>',
    ...
    register_sidebar(array(
        ...
        'description' => esc_html__('Add widgets to Store Sidebar section.', 'storecommerce'),
        'before_widget' => '<div id="%1$s" class="widget storecommerce-widget %2$s">',
        'after_widget' => '</div>',
        'before_title' => '<h2 class="widget-title widget-title-1"><span>',
        'after_title' => '</span></h2>',
    ...
    register_sidebar(array(
        'name' => esc_html__('Contact Page Section', 'storecommerce'),
        'id' => 'contact-page-widgets',
        'description' => esc_html__('Add widgets to Contact Page Section.', 'storecommerce'),
        'before_widget' => '<div id="%1$s" class="widget storecommerce-widget %2$s">',
        'after_widget' => '</div>',
        'before_title' => '<h2 class="widget-title widget-title-1"><span>',
        'after_title' => '</span></h2>',
    ...
    register_sidebar(array(
        'name' => esc_html__('Above Footer Section', 'storecommerce'),
        'id' => 'above-footer-section',
        'description' => esc_html__('Add widgets to above footer section.', 'storecommerce'),
        'before_widget' => '<div id="%1$s" class="widget storecommerce-widget %2$s">',
        'after_widget' => '</div>',
        'before_title' => '<h2 class="widget-title widget-title-1"><span>',
        'after_title' => '</span></h2>',
