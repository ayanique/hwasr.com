    ...
    class StoreCommerce_Store_Features extends AFthemes_Widget_Base
    {
        ...
        function __construct()
        {
            $this->text_fields = array(
                ...
                'storecommerce-store-features-4-icon',
                'storecommerce-store-features-4-title',
                'storecommerce-store-features-4-desc',
            );
        ...
        public function form($instance)
        {
            ...
            echo parent::storecommerce_generate_section_title('storecommerce-store-features-4', 'Store Features 4');
            echo parent::storecommerce_generate_text_input('storecommerce-store-features-4-icon', 'Icon', 'fa fa-repeat');
            echo parent::storecommerce_generate_text_input('storecommerce-store-features-4-title', 'Title', '30 Days Returns');
            echo parent::storecommerce_generate_text_input('storecommerce-store-features-4-desc', 'Descriptions', '30 days money back');
        }
    }
endif;