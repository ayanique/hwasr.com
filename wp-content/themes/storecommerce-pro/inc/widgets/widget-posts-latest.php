...
if (!class_exists('StoreCommerce_Posts_Latest')) :
    ...
    class StoreCommerce_Posts_Latest extends AFthemes_Widget_Base
    {
        ...
        public function widget($args, $instance)
        {
            ...
            $number_of_items = isset($instance['storecommerce-number-of-items']) ? $instance['storecommerce-number-of-items'] : '3';
            ...
            <section class="blog">
                <div class="container-wrapper">
                    ...
                    <div class="blog-wrapper section-body clearfix">
                        <?php
                        $all_posts = storecommerce_get_posts($number_of_items, $category);
        ...
        public function form($instance)
        {
            ...
            echo parent::storecommerce_generate_text_input('storecommerce-number-of-items', __('No. of Items', 'storecommerce'), '3', 'number');
