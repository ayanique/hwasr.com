...
add_filter('woocommerce_product_thumbnails_columns', 'storecommerce_woocommerce_thumbnail_columns');
 ...
 */
function storecommerce_woocommerce_thumbnail_columns()
{
    $cols = storecommerce_get_option('store_product_page_gallery_thumbnail_columns');
    return $cols;
}
 ...
 */
if (!function_exists('storecommerece_remove_review_tab')) {
    /**
     * Product columns wrapper.
     *
     * @return  void
     */
    function storecommerece_remove_review_tab($tabs)
    {
        $review_tab = storecommerce_get_option('store_product_page_review_tab');
        if($review_tab == 'no'){
            unset($tabs['reviews']);
...
add_filter( 'woocommerce_product_tabs', 'storecommerece_remove_review_tab', 98, 1 );
...
function storecommerce_woocommerce_related_products_args($args)
{
    ...
    $posts_per_page = storecommerce_get_option('store_product_page_related_products_per_page');
 ...
 * Remove related products output
 */
if (!function_exists('storecommerece_remove_product_ordering')) {
    /**
     * Product columns wrapper.
     *
     * @return  void
     */
    function storecommerece_remove_product_ordering()
    {
        $sort_products = storecommerce_get_option('store_product_shop_page_product_sort');
        if($sort_products == 'no'){
...
add_action('wp_loaded', 'storecommerece_remove_product_ordering', 9999 );



if (!function_exists('storecommerce_onsale_product_count')) {
    function storecommerce_onsale_product_count($category_id = 0)
    {
        $args = array(
            'post_type' => 'product',
            'posts_per_page' => -1,
...
if (!function_exists('storecommerce_add_to_cart_text')) {
    ...
    function storecommerce_add_to_cart_text($add_to_cart_texts) {
        ...
        $variable = storecommerce_get_option('store_variable_add_to_cart_text');
        $grouped = storecommerce_get_option('store_grouped_add_to_cart_text');
        $external = storecommerce_get_option('store_external_add_to_cart_text');
 ...
 * @since 1.0.0
 */
function storecommerce_autocomplete_scripts_enqueues()
{
...
add_action('wp_enqueue_scripts', 'storecommerce_autocomplete_scripts_enqueues');
 ...
 * @since 1.0.0
 */
function storecommerce_ajax_search()
{
...
add_action('wp_ajax_search_site', 'storecommerce_ajax_search');
add_action('wp_ajax_nopriv_search_site', 'storecommerce_ajax_search');