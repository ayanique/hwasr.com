...
$wp_customize->add_control( 'header_layout',
    array(
        'label'       => esc_html__('Header Layout', 'storecommerce'),
        'description' => esc_html__('Select global header layout', 'storecommerce'),
        'section'     => 'header_options_settings',
        'type'        => 'select',
        'choices'               => array(
            'header-style-1' => esc_html__( 'Header - Default', 'storecommerce' ),
            'header-style-2' => esc_html__( 'Header - Express', 'storecommerce' ),
            'header-style-3' => esc_html__( 'Header - Center', 'storecommerce' )
...
// Setting - show_site_title_section.
$wp_customize->add_setting('header_layout_transparent',
    array(
        'default'           => $default['header_layout_transparent'],
        'capability'        => 'edit_theme_options',
        'sanitize_callback' => 'storecommerce_sanitize_checkbox',
    )
);
$wp_customize->add_control('header_layout_transparent',
    array(
        'label'    => esc_html__('Transparent Header', 'storecommerce'),
        'section'  => 'header_options_settings',
        'type'     => 'checkbox',
        'priority' => 10,
...
$wp_customize->add_control( 'hide_footer_menu_section',
    array(
        'label'    => __( 'Hide footer menu section', 'storecommerce' ),
        'section'  => 'site_footer_settings',
        'type'     => 'checkbox',
        'priority' => 100,
    )
...
$wp_customize->add_control( 'hide_footer_copyright_credits',
    array(
        'label'    => __( 'Hide theme credits', 'storecommerce' ),
        'section'  => 'site_footer_settings',
        'type'     => 'checkbox',
        'priority' => 100,
    )
