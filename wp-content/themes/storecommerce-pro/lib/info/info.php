        ...
        $config = array(
            ...
            'quick_links' => array(
                'theme_url' => array(
                    ...
                    'url'  => 'https://afthemes.com/products/storecommerce-pro/',
                ),
                'demo_url' => array(
                    'text' => esc_html__( 'View Demo', 'storecommerce' ),
                    'url'  => 'https://afthemes.com/storecommerce-pro-premium-ecommerce-wp-theme-for-woocommerce/',
                ),
                'documentation_url' => array(
                    'text' => esc_html__( 'View Documentation', 'storecommerce' ),
                    'url'  => 'https://docs.afthemes.com/storecommerce-pro/',
                ),
                'rating_url' => array(
            ...
            'getting_started' => array(
                'one' => array(
                    ...
                    'button_url'  => 'https://docs.afthemes.com/storecommerce-pro/',
                    'button_type' => 'link',
                    'is_new_tab'  => true,
                ),
                'two' => array(
                ...
                'five' => array(
                    ...
                    'button_url'  => admin_url( 'themes.php?page=storecommerce-pro-details&tab=demo-content' ),
                ...
                'six' => array(
                    ...
                    'button_url'  => 'https://afthemes.com/storecommerce-pro-premium-ecommerce-wp-theme-for-woocommerce/',
                    'button_type' => 'link',
                    'is_new_tab'  => true,
                ),
            ),
