        ...
        <?php
            ...
            ?>
                <header class="searсh-header">
                    <h1 class="page-title"><?php printf( esc_html__( 'Search Results for: %s', 'carbonick' ), '<span>' .get_search_query(). '</span>' ); ?></h1>
                </header>
                <?php
                ...
                $wgl_blog_atts = array(
                    ...
                    'read_more_text' => esc_html__( 'Learn More', 'carbonick' ),
                ...
                <div class="page_404_wrapper">
                    <header class="searсh-header">
                        <h1 class="page-title"><?php esc_html_e( 'Nothing Found', 'carbonick' ); ?></h1>
                    </header>

                    <div class="page-content">
                        <?php if ( is_search() ) : ?>
                            <p class="banner_404_text"><?php esc_html_e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'carbonick' ); ?></p>
                        <?php else : ?>
                            <p class="banner_404_text"><?php esc_html_e( 'It seems we can&rsquo;t find what you&rsquo;re looking for. Perhaps searching can help.', 'carbonick' ); ?></p>
                        <?php endif; ?>
                        <div class="search_result_form">
                            <?php get_search_form(); ?>
                        </div>
                        <!--<div class="carbonick_404_button carbonick_module_button wgl_button wgl_button-xl">
                            <a class="wgl_button_link" href="<?php /*echo esc_url(home_url('/')); */?>"><?php /*esc_html_e( 'Take Me Home', 'carbonick' ); */?></a>
                        </div>-->
