...
if ($nextPost || $prevPost) :
	...
	echo '<section class="carbonick-post-navigation">';
		...
		if (is_a($prevPost, 'WP_Post') || is_a($nextPost, 'WP_Post') ) :
			echo '<a class="back-nav_page" title="', esc_attr__( 'Back to previous page', 'carbonick' ), '" onclick="location.href = document.referrer; return false;">',
				'<span></span><span></span>',
				'<span></span><span></span>',
			'</a>';
		endif;
