	...
	class Wgl_Theme_Panel{
		...
		*/
		...
		public function theme_panel_admin_menu(){
			add_menu_page (
				esc_html__('WebGeniusLab', 'carbonick'),
				esc_html__('WebGeniusLab', 'carbonick'), 
			...
			$submenu = array();
			$submenu[] = array(
				esc_html__('Welcome', 'carbonick'),    //page_title
				esc_html__('Welcome', 'carbonick'),    //menu_title
				'manage_options',                               //capability
			...
			if (current_user_can( 'activate_plugins' )):
				$submenu[] = array(
					esc_html__('Theme Plugins', 'carbonick'),   //page_title
					esc_html__('Theme Plugins', 'carbonick'),   //menu_title
			...
			$submenu[] = array(
				esc_html__('Requirements', 'carbonick'),   //page_title
				esc_html__('Requirements', 'carbonick'),   //menu_title
				'edit_posts',                          //capability
			...
			$submenu[] = array(
				esc_html__('Activate Theme', 'carbonick'),   //page_title
				esc_html__('Activate Theme', 'carbonick'),   //menu_title
				'edit_posts',                           //capability
			...
			$submenu[] = array(
				esc_html__('Help Center', 'carbonick'),   //page_title
				esc_html__('Help Center', 'carbonick'),   //menu_title
				'edit_posts',                           //capability
			...
			if ( class_exists( 'Carbonick_Core' ) ) {
				$submenu[] = array(
					esc_html__('Theme Options', 'carbonick'),   //page_title
					esc_html__('Theme Options', 'carbonick'),   //menu_title
					'edit_posts',                           //capability
